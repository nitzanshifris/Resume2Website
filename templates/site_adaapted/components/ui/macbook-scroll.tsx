...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start sm:scale-50 md:scale-100"
    >
      {/* Lid */}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <iframe
          src={src || "https://vercel.com/marketing"}
