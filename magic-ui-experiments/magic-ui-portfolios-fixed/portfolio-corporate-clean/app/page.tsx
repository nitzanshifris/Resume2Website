...
export default function Portfolio() {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="min-h-screen flex items-center justify-center px-4 py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {cvDataJson.skills.skillCategories.map((category, idx) => (
              <BlurFade key={idx} delay={0.1 * idx} inView>
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900 border-b-2 border-[var(--color-primary)] pb-2">
