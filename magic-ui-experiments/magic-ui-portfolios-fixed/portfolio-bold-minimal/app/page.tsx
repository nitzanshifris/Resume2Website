...
export default function Portfolio() {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="min-h-screen flex items-center justify-center px-4 py-20 bg-gray-50 relative overflow-hidden">
        <DotPattern className="absolute inset-0 opacity-20" />
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <BlurFade delay={0.25} inView>
            <h1 className="text-6xl md:text-8xl font-light mb-8 tracking-tight text-gray-900">
