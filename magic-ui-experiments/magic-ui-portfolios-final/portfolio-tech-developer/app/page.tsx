  ...
  return (
    <main className="min-h-screen bg-gray-950">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-primary)] via-transparent to-[var(--color-secondary)] opacity-20 animate-gradient" />
        <DotPattern className="absolute inset-0 opacity-20" />
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <BlurFade delay={0.25} inView>
            <h1 className="text-7xl md:text-9xl font-bold mb-8 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] bg-clip-text text-transparent">
          ...
          <BlurFade delay={0.75} inView>
            <Button size="lg" className="bg-[var(--color-primary)] hover:bg-[var(--color-secondary)] text-white text-xl px-8 py-6 animate-glow">
              Get In Touch
            </Button>
          </BlurFade>
        </div>
