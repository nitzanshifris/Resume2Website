...
export default function Portfolio() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 py-20 bg-[var(--color-primary)] pattern-gradient-mesh">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-8xl md:text-[12rem] font-black mb-8 text-white uppercase leading-none animate-float">
            {cvDataJson.hero.fullName.split(' ')[0]}
          </h1>
          <p className="text-3xl md:text-5xl mb-12 text-white/90 max-w-3xl mx-auto">
            {cvDataJson.hero.summaryTagline}
          </p>
          <Button size="lg" className="bg-white text-[var(--color-primary)] hover:bg-gray-100 text-xl px-10 py-6 font-bold">
            Explore Work
          </Button>
        </div>
      </section>
