...
export default function Portfolio() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="min-h-screen flex items-center px-8 py-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 lg:col-span-8">
              <BlurFade delay={0.25} inView>
                <div className="border-t-4 border-red-700 pt-8 mb-12">
                  <span className="text-sm uppercase tracking-widest text-gray-600">Portfolio 2024</span>
                </div>
                <h1 className="text-7xl md:text-9xl font-serif font-light mb-8 text-gray-900 leading-none">
                  {cvDataJson.hero.fullName}
                </h1>
              </BlurFade>
              
              <BlurFade delay={0.5} inView>
                <p className="text-3xl md:text-5xl mb-12 text-gray-600 font-serif leading-relaxed max-w-3xl">
              ...
              <BlurFade delay={0.75} inView>
                <div className="flex gap-8">
                  <Button size="lg" className="bg-red-700 hover:bg-red-800 text-white text-lg px-12 py-6">
                    Read More
                  </Button>
                  <Button size="lg" variant="outline" className="border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white text-lg px-12 py-6">
                    Subscribe
                  </Button>
                </div>
              </BlurFade>
            ...
            <div className="col-span-12 lg:col-span-4">
              <BlurFade delay={1} inView>
                <div className="border-l-2 border-gray-200 pl-8 mt-20">
                  <h3 className="text-2xl font-serif mb-4">Quick Facts</h3>
      ...
      {/* Experience Section */}
      <section className="py-24 md:py-32 px-4 bg-stone-50">
        <div className="max-w-7xl mx-auto">
          <BlurFade delay={0.25} inView>
                ...
                <div className="bg-white/5 backdrop-blur rounded-lg p-8 hover:shadow-lg transition-shadow">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-xl md:text-2xl text-red-700">
                        {exp.companyName}
                      </p>
                    </div>
            ...
            {cvDataJson.education.educationItems.map((edu, idx) => (
              <BlurFade key={idx} delay={0.25 * (idx + 1)} inView>
                <div className="text-center p-8 rounded-lg bg-white/5 backdrop-blur">
                  <GraduationCap className="mx-auto mb-6 h-12 w-12 text-red-700" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <BlurFade delay={1} inView>
            <div className="flex gap-6 justify-center">
              <Button size="lg" className="bg-red-700 hover:bg-red-800 text-white text-xl px-8 py-6">
