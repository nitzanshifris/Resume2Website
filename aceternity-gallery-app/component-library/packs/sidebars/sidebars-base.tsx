...
export function CollapsibleSidebarLayout({
  ...
  return (
    ...
    >
      <CollapsibleSidebarWrapper open={open} setOpen={setOpen}>
        <CollapsibleSidebarBody className="justify-between gap-10">
          <div className="flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
            {open ? <Logo /> : <LogoIcon />}
            <div className="mt-8 flex flex-col">
              {primaryLinks.map((link, idx) => (
                <CollapsibleSidebarLink key={idx} link={link} />
              ))}
            </div>
            <div className="mt-4">
              <div className="h-px w-full bg-neutral-200 dark:bg-neutral-700"></div>
...
// Dummy dashboard component for collapsible sidebar
...
export const CollapsibleSidebarWrapper = ({
  children,
  open,
  setOpen,
}: {
...
export const CollapsibleSidebarBody = (props: React.ComponentProps<typeof motion.div>) => {
  return (
    <>
      <CollapsibleDesktopSidebar {...props} />
      <CollapsibleMobileSidebar {...props} />
    </>
  );
};

export const CollapsibleDesktopSidebar = ({
  className,
  children,
  ...props
}: React.ComponentProps<typeof motion.div>) => {
...
export const CollapsibleMobileSidebar = ({
  className,
  children,
  ...props
}: React.ComponentProps<typeof motion.div>) => {
...
export const CollapsibleSidebarLink = ({
  link,
  className,
  ...props
}: {
