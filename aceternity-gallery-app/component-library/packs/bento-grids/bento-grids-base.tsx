...
// Card structure for ThreeColumnsWithImages
const ImageCardSkeletonBody = ({
  children,
  className,
}: {
  children: React.ReactNode;
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 md:px-8">
      <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2">
        <motion.div
          className="col-span-1 row-span-1 h-[400px] overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-lg md:col-span-2 dark:border-gray-800 dark:bg-gray-900"
        ...
        >
          ...
          <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
            Explore our global presence with real-time data visualization.
          </p>
          <div className="relative h-[280px] w-full overflow-hidden rounded-lg bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800">
            <canvas
              ref={canvasRef}
              style={{
                position: 'absolute',
        ...
        >
          <div className="flex-1 rounded-xl border border-gray-200 bg-gradient-to-br from-purple-50 to-pink-50 p-6 shadow-lg dark:border-gray-800 dark:from-purple-900/20 dark:to-pink-900/20">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">
              Real-time Analytics
            </h3>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Monitor your metrics and KPIs with our advanced dashboard.
            </p>
          ...
          <div className="flex-1 rounded-xl border border-gray-200 bg-gradient-to-br from-green-50 to-teal-50 p-6 shadow-lg dark:border-gray-800 dark:from-green-900/20 dark:to-teal-900/20">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">
              AI-Powered Insights
            </h3>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="mt-4">
              <div className="h-2 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
                <div className="h-2 w-3/4 rounded-full bg-gradient-to-r from-green-500 to-teal-500" />
              </div>
        ...
        <motion.div
          className="col-span-1 row-span-1 rounded-xl border border-gray-200 bg-gradient-to-br from-orange-50 to-red-50 p-6 shadow-lg md:col-span-3 dark:border-gray-800 dark:from-orange-900/20 dark:to-red-900/20"
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <motion.button
              className="rounded-full bg-gradient-to-r from-orange-500 to-red-500 px-8 py-3 font-semibold text-white shadow-lg transition-all hover:shadow-xl"
