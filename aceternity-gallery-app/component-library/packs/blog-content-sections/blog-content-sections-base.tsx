  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 md:flex-row md:px-8">
      ...
      <div className="flex max-w-2xl flex-1 flex-col">
        <Image
          src={blogWithToc.thumbnail}
          alt={blogWithToc.title}
          className="h-60 w-full rounded-3xl object-cover md:h-[30rem]"
          height={720}
          width={1024}
        />
        ...
        <div className="prose prose-sm dark:prose-invert mt-10">
          <ReactMarkdown>{blogWithToc.content}</ReactMarkdown>
        </div>
        ...
        <div className="mt-10 flex items-center">
          <Image
            src={blogWithToc.authorImage}
            alt={blogWithToc.author}
            className="h-5 w-5 rounded-full"
            height={20}
            width={20}
          />
          ...
          <div className="mx-2 h-1 w-1 rounded-full bg-neutral-200 dark:bg-neutral-700" />
          <p className="pl-1 text-sm text-neutral-600 dark:text-neutral-400">
            {format(new Date(blogWithToc.date), "LLLL d, yyyy")}
          </p>
        </div>
      </div>
    </div>
