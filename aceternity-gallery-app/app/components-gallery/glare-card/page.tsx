...
const componentConfig = {
  ...
  codeTemplate: `import { GlareCard } from "@/components/ui/glare-card";
...
export function MyComponent() {
  ...
  importStatement: 'import { GlareCard } from "@/components/ui/glare-card";'
};
...
export default function GlareCardPage() {
  ...
  const variants = [
    { id: "demo", name: "Demo", component: <GlareCardDemo /> },
    { id: "simple", name: "Simple", component: <GlareCardSimple /> },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-semibold">Glare Card</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <section className="mb-12">
          ...
          <div className="border border-neutral-800 rounded-lg p-6">
            <p className="text-neutral-400 mb-4">
              Test different Glare Card configurations with live preview.
            </p>
            <Button 
...
export function GlareCardExample() {
  return (
      ...
      <p className="text-white font-bold text-xl mt-4">Aceternity</p>
        ...
        <section>
          ...
          <div className="space-y-6">
            {/* GlareCard Props */}
            <div>
              <h3 className="text-lg font-medium mb-4 text-blue-400">GlareCard</h3>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-neutral-800">
                    <tr className="hover:bg-neutral-900/25">
                      ...
                      <td className="p-4 text-neutral-400">The content to be displayed inside the card</td>
                      <td className="p-4 font-mono text-green-400">Yes</td>
                    </tr>
                    <tr className="hover:bg-neutral-900/25">
                      <td className="p-4 font-mono text-blue-400">className</td>
                      <td className="p-4 font-mono text-purple-400">string</td>
                      <td className="p-4 text-neutral-400">Additional CSS class names to apply to the card</td>
                      <td className="p-4 font-mono text-orange-400">No</td>
                    </tr>
                  </tbody>
                </table>
              </div>
