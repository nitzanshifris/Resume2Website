...
export default function SimpleButtonPage() {
  ...
  const buttonCode = `<button className="px-4 py-2 rounded-md border border-neutral-300 bg-neutral-100 text-neutral-500 text-sm hover:-translate-y-1 transform transition duration-200 hover:shadow-md">
  Simple
</button>`;
    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold">Simple Button</h1>
          <p className="text-muted-foreground text-lg">
            Elegant button for your website
          </p>
          <div className="flex gap-2 flex-wrap">
            ...
            <Badge variant="secondary">Transform Effect</Badge>
          </div>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Interactive preview of the simple button</CardDescription>
        </CardHeader>
        <div className="p-6">
