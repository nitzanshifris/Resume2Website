...
export default function FavouriteButtonPage() {
  ...
  const buttonCode = `<button className="px-8 py-2  bg-black text-white text-sm rounded-md font-semibold hover:bg-black/[0.8] hover:shadow-lg">
  Favourite
</button>`;
    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold">Favourite Button</h1>
          <p className="text-muted-foreground text-lg">
            Favourite button for your website
          </p>
          <div className="flex gap-2 flex-wrap">
            <Badge variant="secondary">Classic</Badge>
            <Badge variant="secondary">Simple Hover</Badge>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Interactive preview of the favourite button</CardDescription>
        </CardHeader>
        <div className="p-6">
      ...
      <Card>
        ...
        <div className="p-6 space-y-4">
          <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
            <li>Perfect for classic interfaces</li>
