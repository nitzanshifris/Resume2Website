...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-10 w-10 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 mb-2" />
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-green-500 mb-2" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-2">
          Efficient
        </p>
      ...
      <motion.div
        ...
        className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
      >
        <div className="h-10 w-10 rounded-full bg-gradient-to-r from-orange-500 to-red-500 mb-2" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-2">
          Scalable
        </p>
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          There are many frameworks out there like React, Vue, Angular...
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Choose wisely.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
  );
