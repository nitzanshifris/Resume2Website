...
class ComponentRegistry:
    ...
    def __init__(self, registry_path: Optional[Path] = None):
        ...
        if registry_path is None:
            registry_path = Path(__file__).parent.parent.parent / "aceternity-components-library" / "registry" / "component-registry.json"
    ...
    def _load_registry(self) -> Dict:
        ...
        try:
            ...
            logger.error(f"Component registry not found at {self.registry_path}")
            return {}
