          ...
          <div className="flex flex-col items-center lg:items-start text-left lg:pl-32">
            ...
            <div className="flex flex-col items-center lg:items-start gap-6 mb-12">
              <Button
                ...
                className={`px-6 py-4 text-lg sm:px-10 sm:py-8 sm:text-xl font-semibold rounded-full bg-accent text-accent-foreground hover:bg-accent/90 transition-all duration-300 ease-in-out shadow-lg hover:shadow-xl transform hover:-translate-y-1 relative overflow-hidden ${
                  !isFormVisible ? 'before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:animate-shimmer before:bg-[length:200%_100%]' : ''
                }`}
                style={!isFormVisible ? {
