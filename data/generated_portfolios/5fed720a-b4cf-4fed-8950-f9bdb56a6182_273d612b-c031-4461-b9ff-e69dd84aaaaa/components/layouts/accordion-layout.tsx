                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                          <div className="h-full bg-white rounded-xl border border-blue-200/60 shadow-sm hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-1 p-5">
                            ...
                            <h4 className="font-bold text-base mb-2 text-foreground">Key Achievement</h4>
                            <p className="text-sm text-muted-foreground leading-relaxed mb-3">Led successful product launch</p>
                        ...
                        >
                          <div className="h-full bg-white rounded-xl border border-green-200/60 shadow-sm hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-1 p-5">
                            ...
                            <h4 className="font-bold text-base mb-2 text-foreground">Team Impact</h4>
                            <p className="text-sm text-muted-foreground leading-relaxed mb-3">Managed cross-functional team</p>
                            <div className="space-y-2">
                              <div className="flex justify-between text-xs text-muted-foreground">
                        ...
                        >
                          <div className="h-full bg-white rounded-xl border border-purple-200/60 shadow-sm hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-1 p-5">
                            ...
                            <h4 className="font-bold text-base mb-2 text-foreground">Business Impact</h4>
                            <p className="text-sm text-muted-foreground leading-relaxed mb-3">Increased revenue by 40%</p>
                            <div className="space-y-2">
                              <div className="flex justify-between text-xs text-muted-foreground">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(item.technologies || []).map((tech, idx) => {
                          ...
                          const categoryStyles = {
                            ...
                            other: 'bg-gradient-to-r from-muted/50 to-muted text-foreground border-border/60 hover:from-muted hover:to-muted/80'
                          }
