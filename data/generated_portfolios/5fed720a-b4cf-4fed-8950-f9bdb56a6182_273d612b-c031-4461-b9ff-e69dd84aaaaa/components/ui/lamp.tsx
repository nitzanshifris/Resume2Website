    ...
    >
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
        ...
        >
          ...
          <div className="absolute w-[100%] left-0 bg-background h-full bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        >
          <div className="absolute w-[100%] right-0 bg-background h-full bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-accent opacity-30 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-accent/60 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
