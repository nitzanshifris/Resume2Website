  ...
  ({ className, variant = "default", size = "icon", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute top-1/2 -translate-y-1/2 left-0 h-10 w-10 md:h-16 md:w-16 rounded-full",
  ...
  ({ className, variant = "default", size = "icon", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute top-1/2 -translate-y-1/2 right-0 h-10 w-10 md:h-16 md:w-16 rounded-full",
          "bg-accent text-accent-foreground shadow-lg",
          "transition-all duration-300 ease-in-out",
          "hover:bg-accent/90 hover:scale-105",
          "disabled:opacity-50 disabled:scale-100",
