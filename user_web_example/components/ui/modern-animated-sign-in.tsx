    ...
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      {subHeader && (
        <BoxReveal boxColor='var(--skeleton)' duration={0.3} className='pb-4'>
          <p className='text-neutral-600 text-base max-w-sm dark:text-neutral-300 leading-relaxed'>
            {subHeader}
          </p>
        </BoxReveal>
      )}
      ...
      {googleLogin && (
        <>
          ...
          >
            <button
              className='g-button group/btn bg-white w-full rounded-lg border border-gray-300 h-12 font-medium outline-hidden hover:cursor-pointer hover:shadow-md transition-all duration-200 hover:bg-gray-50 flex items-center justify-center gap-3'
              type='button'
            ...
            >
              ...
              <span className='text-gray-700 font-medium'>{googleLogin}</span>
            </button>
          </BoxReveal>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {fields.map((field) => (
            <section key={field.label} className='flex flex-col gap-2'>
              <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
                <Label htmlFor={field.label} className="text-sm font-semibold text-gray-700 mb-1">
        ...
        >
          <button
            className='bg-gradient-to-r from-emerald-500 via-sky-400 to-blue-600 hover:from-emerald-600 hover:via-sky-500 hover:to-blue-700 
            relative group/btn block w-full text-white rounded-lg h-12 font-semibold 
            shadow-lg hover:shadow-xl transition-all duration-200 outline-hidden hover:cursor-pointer transform hover:scale-[1.02]'
            type='submit'
          >
            {submitButton}
            <BottomGradient />
        ...
        {textVariantButton && goTo && (
          <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
            <section className='mt-6 text-center hover:cursor-pointer'>
              <button
                className='text-sm text-blue-600 hover:text-blue-700 hover:underline font-medium transition-colors duration-200 outline-hidden'
                onClick={goTo}
              >
                {textVariantButton}
              </button>
