...
// Note: We'll load this dynamically in useEffect since this is a Client Component
...
export default function PortfolioPage() {
  ...
  const [portfolioData, setPortfolioData] = useState(() => {
    // Load demo data synchronously as fallback
    try {
  ...
  useEffect(() => {
    const loadCVData = async () => {
      try {
        ...
        // First try to load injected data dynamically
        try {
          ...
          if (injectedModule.useRealData && injectedModule.portfolioData) {
            ...
            console.log('👤 Hero name from injected data:', injectedModule.portfolioData.hero?.name)
          ...
          console.log('💻 No injected data module found, checking other sources...')
        }
        ...
        console.log('ℹ️ Error in data loading, using demo content')
        // Keep using demo data that's already loaded
      } finally {
        setIsLoading(false)
      }
