...
export const initialData: PortfolioData = {
  ...
  courses: {
    ...
    courseItems: [
      { title: "Advanced Draping Techniques", institution: "The Fashion Institute", year: "2022", icon: "Award" },
      { title: "Sustainable Textile Science", institution: "FutureLearn", year: "2021", icon: "Award" },
      { title: "Digital Fashion Pro", institution: "Udemy", year: "2020", icon: "Award" },
    ],
  },
  publications: {
  ...
  hobbies: {
    ...
    hobbyItems: [
      { title: "Vintage Textile Restoration", icon: "Heart" },
      { title: "Argentine Tango", icon: "Heart" },
      { title: "Ikebana (Japanese Flower Arranging)", icon: "Heart" },
      { title: "Sketching Urban Landscapes", icon: "DraftingCompass" },
      { title: "Pottery and Ceramics", icon: "Palette" },
      { title: "French New Wave Cinema", icon: "Star" },
    ],
  },
  memberships: {
