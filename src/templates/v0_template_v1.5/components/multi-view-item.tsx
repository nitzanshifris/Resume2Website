...
export function MultiViewItem({
  ...
  return (
    <div className="group relative h-full border-4 border-red-500">
      <div className="absolute top-0 left-0 z-50 bg-red-500 text-white px-2 py-1 text-xs font-bold">
        MULTI-VIEW-ITEM: {sectionKey}/{itemId}
      </div>
