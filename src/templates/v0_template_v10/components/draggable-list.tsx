...
function DraggableItem({ id, children, index, handlePosition = 'left' }: DraggableItemProps) {
  ...
  // Position cards within their grid cells to spread them out
  const getPositionClass = () => {
    if (!isEditMode) return ""
    switch (index % 3) {
      case 0: return "justify-self-start"  // Left card goes left
      case 1: return "justify-self-center" // Middle card stays center  
      case 2: return "justify-self-end"    // Right card goes right
      default: return ""
    }
  }
