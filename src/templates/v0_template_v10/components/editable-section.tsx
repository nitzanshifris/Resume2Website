              ...
              >
                {showMoveButtons && (
                  <div className="flex gap-1">
                    <Button
                      onClick={onMoveUp}
                      className="flex items-center justify-center px-3 py-3 bg-blue-500 hover:bg-blue-600 text-white disabled:opacity-40 rounded-lg shadow-lg transition-colors"
                      disabled={isFirst}
