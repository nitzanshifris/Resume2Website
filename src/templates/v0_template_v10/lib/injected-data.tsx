 ...
 * Using comprehensive test data with all URL types
 */

import { adaptCV2WebToTemplate } from './cv-data-adapter'
import { mockCVData } from './mock-data'

// Use mock data for testing
const extractedCVData = mockCVData;

// Original data (commented out for testing)
const originalExtractedCVData = {
  "hero": {
