          ...
          {isExpanded && (
            <motion.div
              ...
              <div className="flex-1 overflow-y-auto overflow-x-hidden px-3 py-2">
                ...
                >
                  <div className="relative group flex items-center rounded-xl overflow-hidden">
                    {/* Move buttons - only in edit mode */}
                    {isEditMode && onMoveSection && navItem.sectionKey && (
                      <div className="flex gap-0.5">
                        <Button
                          onClick={(e) => {
                            e.preventDefault()
                            e.stopPropagation()
                            onMoveSection(navItem.sectionKey!, 'up')
                          }}
                          size="sm"
                          variant="ghost"
                          className="h-5 w-5 p-0 bg-blue-500 hover:bg-blue-600 text-white rounded-sm"
                        >
                        ...
                        <Button
                          onClick={(e) => {
                            e.preventDefault()
                            e.stopPropagation()
                            onMoveSection(navItem.sectionKey!, 'down')
                          }}
                          size="sm"
                          variant="ghost"
                          className="h-5 w-5 p-0 bg-orange-500 hover:bg-orange-600 text-white rounded-sm"
                        >
                    ...
                    <Link
                      ...
                      className={cn(
                        "relative group flex items-center pr-3 py-3 rounded-xl flex-1",
