    ...
    <div className="h-screen w-full bg-background flex flex-col items-center justify-center overflow-hidden rounded-md py-8 px-4">
          ...
          <div className="relative group">
            <div className="relative" ref={imageContainerRef}>
              <div className={cn(
                ...
                <div
                  className={cn("relative w-full h-full", isEditMode && "cursor-move")}
      ...
      <div className="mt-6 relative">
        {data.contactButtonText ? (
          <>
            ...
            >
              <a href="#contact" className="flex items-center">
                ...
                <EditableText
                  as="span"
                  initialValue={data.contactButtonText ?? "Contact Me"}
                  onSave={(value) => onSave("contactButtonText", value)}
            ...
            {isEditMode && (
              <Button
                onClick={() => onSave("contactButtonText", "")}
                size="sm"
                variant="secondary"
                className="absolute -top-2 -right-2 h-6 w-6 p-0 rounded-full shadow-lg bg-red-500 hover:bg-red-600 text-white"
          ...
          isEditMode && (
            <Button
              onClick={() => onSave("contactButtonText", "Contact Me")}
              className="px-6 py-3 text-base font-medium rounded-lg bg-accent/50 text-accent-foreground hover:bg-accent/70 transition-colors duration-200 shadow-sm border-2 border-dashed border-accent"
            >
              + Add Contact Button
            </Button>
          )
