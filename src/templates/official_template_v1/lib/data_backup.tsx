...
contract DigitalAssets is ERC721 {
  ...
  projects_experimental: {
    sectionTitle: "Featured Projects (Beta)",
    layoutConfig: {
    ...
    projectItems: [
      {
        ...
        description: "Template repository showcasing the v0 template implementation with smart card system and universal sizing features.",
      ...
      },
      {
        ...
        description: "Example tweet card showcasing social media integration and dynamic content display.",
        link: "https://x.com/0x_Reef/status/1956757731957780758",
        icon: "DraftingCompass",
        viewMode: "tweet",
        tweetId: "1956757731957780758"
      },
      {
        _key: "project-exp-3",
        title: "Video Player Example",
        description: "Video content showcase with embedded player functionality and responsive design.",
        link: "https://www.youtube.com/watch?v=SGLhrRCBu-s&t=304s&pp=ygUNRGVrZWwgbWFnbmV0bw%3D%3D",
        icon: "Star",
        viewMode: "video",
        videoUrl: "https://www.youtube.com/watch?v=SGLhrRCBu-s&t=304s&pp=ygUNRGVrZWwgbWFnbmV0bw%3D%3D"
      },
      {
        _key: "project-exp-4",
        title: "Link Preview Example",
        description: "Dynamic link preview showcasing external website integration with rich preview cards.",
        link: "https://www.dreamsjournal.app/blog",
        icon: "SwatchBook",
        viewMode: "uri",
        linkUrl: "https://www.dreamsjournal.app/blog"
      },
      {
        _key: "project-exp-5",
        title: "Code Block Example",
        description: "Advanced code display with syntax highlighting and multiple language support.",
  ...
  private calculatePerformance(allocations: Allocation[]): number {
    return allocations.reduce((score, allocation) => {
      ...
      },
      {
        ...
        description: "Multi-image showcase with carousel functionality and responsive image handling.",
