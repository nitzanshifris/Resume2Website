...
def normalize_url(url: str) -> str:
    ...
    # Special case: handle "Not available" or similar placeholders
    if url.lower() in ['not available', 'not available (extracted from image)', 'n/a', 'none']:
        # Return a valid placeholder URL that indicates the link exists but URL is unknown
        return 'https://placeholder.url/not-available'
