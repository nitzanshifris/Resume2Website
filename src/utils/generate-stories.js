...
${lines.join(',\n')}
    ...
    const hasItems = 'items' in componentProps;
    let dynamicImport = '';
    let dynamicStory = '';
    if (hasItems) {
      dynamicImport = "import { DynamicPlayground } from '../../storybook/DynamicPlayground';\n";
      dynamicStory = `\n// \"Dynamic\" – draggable & resizable playground\nexport const Dynamic: Story = {\n  render: (args: any) => (\n    <DynamicPlayground Component={Component} items={args.items} {...args} />\n  ),\n  args: ${argsBlock}\n};`;
    }

    const content = `${AUTO_HEADER}import type { Meta, StoryObj } from '@storybook/react';
import * as Module from './index';
import React from 'react';
${dynamicImport}// Pick the default export if available, otherwise the first named export
