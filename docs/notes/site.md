they way the website should work . 
...
after payment - the user portfolio get deployed in vercel and the user is getting a custom domain for hes portfolio , based on his name and sub domaions 
 .portfolios
