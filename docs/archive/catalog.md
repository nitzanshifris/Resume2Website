{
  ...
  "components": {
    "3DCard": {
      ...
      "cv_sections": ["projects", "achievements", "certifications"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "PinContainer": {
      ...
      "cv_sections": ["projects", "publications", "patents"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "AnimatedModal": {
      ...
      "cv_sections": ["projects", "experience"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "AnimatedTabs": {
      ...
      "cv_sections": ["skills", "projects", "experience"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "AnimatedTestimonials": {
      ...
      "cv_sections": ["achievements", "recommendations"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "AnimatedTooltip": {
      ...
      "cv_sections": ["languages", "skills", "contact"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "BentoGrid": {
      ...
      "cv_sections": ["skills", "services", "hobbies", "certifications"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "CardHoverEffect": {
      ...
      "cv_sections": ["projects", "experience", "education", "volunteer"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "CardSpotlight": {
      ...
      "cv_sections": ["certifications", "achievements", "patents"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "CardStack": {
      ...
      "cv_sections": ["testimonials", "achievements", "projects"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "Carousel": {
      ...
      "cv_sections": ["projects", "testimonials", "certifications"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "CodeBlock": {
      ...
      "cv_sections": ["projects", "technical_skills"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "ColourfulText": {
      ...
      "cv_sections": ["hero", "hobbies", "creative_sections"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "ContainerTextFlip": {
      ...
      "cv_sections": ["hero", "section_headers"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "EvervaultCard": {
      ...
      "cv_sections": ["skills", "certifications", "achievements"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "ExpandableCards": {
      ...
      "cv_sections": ["projects", "experience", "publications"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "FeatureSections": {
      ...
      "cv_sections": ["skills", "services", "achievements"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "FlipWords": {
      ...
      "cv_sections": ["hero", "languages", "hobbies"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "GlareCard": {
      ...
      "cv_sections": ["summary", "achievements", "certifications"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "GlowingStars": {
      ...
      "cv_sections": ["achievements", "skills", "hero"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "InfiniteMovingCards": {
      ...
      "cv_sections": ["certifications", "testimonials", "courses"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "LinkPreview": {
      ...
      "cv_sections": ["projects", "publications", "references"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "Meteors": {
      ...
      "cv_sections": ["achievements", "any_section"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "StickyScrollReveal": {
      ...
      "cv_sections": ["experience", "projects", "skills"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "TextHoverEffect": {
      ...
      "cv_sections": ["navigation", "headers"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "TextRevealCard": {
      ...
      "cv_sections": ["achievements", "summary"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "Timeline": {
      ...
      "cv_sections": ["experience", "education", "volunteer"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "TracingBeam": {
      ...
      "cv_sections": ["experience", "education"],
      "mvp_suitable": true,
      "mvp_adaptations": {
    ...
    "WobbleCard": {
      ...
      "cv_sections": ["skills", "hobbies", "languages"],
      "mvp_suitable": true,
      "mvp_adaptations": {
