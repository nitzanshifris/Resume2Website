    ...
    >
      ...
      <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 bg-[#050505]"></div>
        </div>
  ...
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        ...
        <div className="w-[4.1rem] mt-[2px] h-6 p-[0.5px] rounded-[4px] flex flex-col justify-end items-center">
...
const IconCaretUpFilled = ({ className }: { className: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M11.0001 9.82843V20H13.0001V9.82843L18.293 15.1213L19.7072 13.7071L12.0001 6L4.29297 13.7071L5.70718 15.1213L11.0001 9.82843Z" />
    </svg>
  );
};
...
const IconCaretDownFilled = ({ className }: { className: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M11.0001 14.1716V4H13.0001V14.1716L18.293 8.87868L19.7072 10.2929L12.0001 18L4.29297 10.2929L5.70718 8.87868L11.0001 14.1716Z" />
    </svg>
  );
};
...
const IconCaretLeftFilled = ({ className }: { className: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M9.82843 11.0001L15.1213 5.70718L13.7071 4.29297L6 12.0001L13.7071 19.7072L15.1213 18.293L9.82843 13.0001H20V11.0001H9.82843Z" />
    </svg>
  );
};
...
const IconCaretRightFilled = ({ className }: { className: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M14.1716 11.0001L8.87868 5.70718L10.2929 4.29297L18 12.0001L10.2929 19.7072L8.87868 18.293L14.1716 13.0001H4V11.0001H14.1716Z" />
    </svg>
  );
};
...
// Small helper to check if we're on mobile
