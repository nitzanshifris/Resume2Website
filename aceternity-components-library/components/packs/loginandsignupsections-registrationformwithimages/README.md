...
A modern registration form with testimonials, grid lines, and social login, designed for shadcn/ui and Tailwind CSS v4 projects.
...
1. Copy the `RegistrationFormWithImages` component from `LoginAndSignupSections/RegistrationFormWithImages/code.tsx` into your project.
2. Import and use it in your page or layout:

```tsx
import { RegistrationFormWithImages } from "../../LoginAndSignupSections/RegistrationFormWithImages/code";

export default function Page() {
  return <RegistrationFormWithImages />;
}
```
...
- Social login (GitHub)
- Testimonial avatars and grid lines
- Responsive design
- Dark mode support
