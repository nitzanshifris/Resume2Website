...
A clean and modern footer with four grid sections for navigation, social links, legal, and registration.
...
1. Copy the `SimpleFooterWithFourGrids` component from `Footers/SimpleFooterWithFourGrids/code.tsx` into your project.
2. Import and use it in your page or layout:

```tsx
import { SimpleFooterWithFourGrids } from "../../Footers/SimpleFooterWithFourGrids/code";
...
## Features
- Four grid sections: Pages, Socials, Legal, Register
- Responsive design
- Dark mode support
