...
const TEMPLATES = [
  { title: "Startup Landing Page Template", href: "/templates/startup-landing-page" },
  { title: "AI SaaS Template", href: "/templates/ai-saas-template" },
  { title: "Proactiv Marketing Template", href: "/templates/proactiv-marketing-template" },
  { title: "Agenlabs Agency Template", href: "/templates/agenlabs-agency-template" },
  { title: "DevPro Portfolio Template", href: "/templates/devpro-portfolio-template" },
  { title: "Foxtrot Marketing Template", href: "/templates/foxtrot-marketing-template" },
];
...
const PROGRAMMATIC_SEO_PAGES = [
  { title: "Best Modern Design Templates", href: "/best-modern-design-templates" },
  { title: "Best AI SaaS Templates", href: "/best-ai-saas-templates" },
  { title: "Best Marketing Templates", href: "/best-marketing-templates" },
  { title: "Best Minimal Templates in React and Next.js", href: "/best-minimal-templates-in-react-and-nextjs" },
  { title: "Best components and templates with Framer Motion", href: "/best-components-and-templates-with-motion/react" },
  { title: "Amazing Tailwind CSS and Framer Motion Components", href: "/amazing-tailwindcss-and-motion/react-components" },
];
