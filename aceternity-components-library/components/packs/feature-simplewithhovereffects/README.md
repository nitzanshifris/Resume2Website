# Simple Feature Section with Hover Effects

A simple feature section with icons and hover effects, ideal for showcasing product features in a grid layout.
...
1. Copy the `FeaturesSectionDemo` component from `Feature sections/SimpleWithHoverEffects/code.tsx` into your project.
2. Import and use it in your page or layout:

```tsx
import { FeaturesSectionDemo } from "../../Feature sections/SimpleWithHoverEffects/code";
