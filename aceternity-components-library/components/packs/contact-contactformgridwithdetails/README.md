...
A modern contact form with a grid layout, animated map pin, and contact details, designed for shadcn/ui and Tailwind CSS v4 projects.
...
1. Copy the `ContactFormGridWithDetails` component from `Contact Sections/ContactFormGridWithDetails/code.tsx` into your project.
2. Import and use it in your page or layout:

```tsx
import { ContactFormGridWithDetails } from "../../Contact Sections/ContactFormGridWithDetails/code";
...
- Animated map pin with location indicator
- Contact details section with email and phone
...
- Download the world map SVG from the provided link and place it in your public directory. 