...
export const simplePlans: Plan[] = [
  {
    id: PricingPlan.hobby,
    name: "Hobby",
    price: 0,
    currency: "$",
    subText: "Great to get started",
    features: [
      "Up to 3 projects",
      "Basic analytics",
      "Community support",
    ...
    onClick: () => {
      console.log("Hobby plan selected");
    },
  },
  {
    id: PricingPlan.starter,
    name: "Starter",
    price: 19,
    currency: "$",
  ...
  },
  {
    ...
    price: 49,
    currency: "$",
    subText: "Best for scaling businesses",
    features: [
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
          {simplePlans.map((plan) => (
            <div
              key={plan.id}
              className={cn(
                "relative rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700",
                plan.featured && "ring-2 ring-indigo-600 dark:ring-indigo-500"
              )}
            >
              {plan.featured && (
                <div className="absolute -top-5 left-0 right-0 mx-auto w-32">
                  <div className="rounded-full bg-indigo-600 px-3 py-1 text-center text-sm font-medium text-white dark:bg-indigo-500">
                    Most Popular
                  </div>
                </div>
              )}
              ...
              <ul className="mb-8 space-y-4">
                {plan.features.map((feature) => (
                  <li key={feature} className="flex items-start">
                    <IconCheck className="mr-3 h-5 w-5 flex-shrink-0 text-indigo-600 dark:text-indigo-400" />
                ...
                <div className="mb-8 border-t border-gray-200 pt-8 dark:border-gray-700">
                  ...
                  <ul className="space-y-3">
                    {plan.additionalFeatures.map((feature) => (
                      <li key={feature} className="flex items-start">
                        <IconPlus className="mr-3 h-4 w-4 flex-shrink-0 text-indigo-600 dark:text-indigo-400" />
                        <span className="text-sm text-gray-700 dark:text-gray-300">
                          {feature}
                        </span>
                      </li>
              ...
              <button
                ...
                className={cn(
                  "w-full rounded-lg px-6 py-3 text-center text-sm font-semibold transition-all duration-200",
                  plan.featured
                    ? "bg-indigo-600 text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600"
                    : "bg-gray-50 text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:ring-gray-600 dark:hover:bg-gray-600"
                )}
              >
                {plan.buttonText}
              </button>
