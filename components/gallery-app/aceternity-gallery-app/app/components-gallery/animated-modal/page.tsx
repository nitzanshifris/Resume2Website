...
} from "@/component-library/components/ui/animated-modal";
...
const variants = [
  ...
  {
    name: "Contact Form",
    component: AnimatedModalGalleryForm,
  },
  {
    name: "Confirmation Dialog",
    component: AnimatedModalGalleryConfirmation,
  },
  {
    name: "Minimal Design",
    component: AnimatedModalGalleryMinimal,
  }
];
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-400">
            A customizable modal with smooth animated transitions and 3D effects
          </p>
        </div>
