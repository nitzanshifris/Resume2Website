...
export default function ContactSectionsGalleryPage() {
  const contactSectionsPack = getPackById("contact-sections");
  const [copiedCode, setCopiedCode] = useState<string | null>(null);
  const variants = contactSectionsPack?.variants || [];
  const [selectedVariant, setSelectedVariant] = useState(variants[0]);

  if (!contactSectionsPack) {
    return (
      <div className="flex items-center justify-center h-screen">
        <p>Contact Sections pack not found</p>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                {contactSectionsPack.title}
              </h1>
            </div>
          </div>

          <p className="text-lg text-gray-300 mb-6 max-w-4xl">
            {contactSectionsPack.description}
          </p>
          ...
          <div className="flex flex-wrap gap-6 mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300">{contactSectionsPack.dependencies.length} Dependencies</span>
            </div>
          </div>
        </div>
        ...
        <Tabs defaultValue="gallery" className="w-full">
          ...
          <TabsContent value="code" className="space-y-6">
              ...
              <CardContent className="p-6">
                ...
                <div className="relative">
                  <pre className="bg-slate-900 p-4 rounded-lg text-gray-300 text-sm overflow-x-auto">
                    <code>{contactSectionsPack.installCommand}</code>
                  </pre>
                  <Button 
                    variant="outline" 
                    size="sm"
                    className="absolute top-3 right-3 border-slate-600"
                    onClick={() => copyToClipboard(contactSectionsPack.installCommand, "install")}
                  >
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-white mb-4">Add Shadow Styles</h3>
                <p className="text-gray-300 mb-4">Add these shadow styles to your globals.css file:</p>
                <div className="relative">
                  <pre className="bg-slate-900 p-4 rounded-lg text-gray-300 text-sm overflow-x-auto">
    ...
    box-shadow: 0px 2px 3px -1px rgba(0, 0, 0, 0.1),
      ...
      0px 0px 0px 1px rgba(25, 28, 33, 0.08);
                  ...
                  <Button 
                    ...
                    size="sm"
                    className="absolute top-3 right-3 border-slate-600"
                    onClick={() => copyToClipboard(`@layer utilities {
  .shadow-derek {
    box-shadow: 0px 0px 0px 1px rgb(0 0 0 / 0.06),
      0px 1px 1px -0.5px rgb(0 0 0 / 0.06), 0px 3px 3px -1.5px rgb(0 0 0 / 0.06),
      0px 6px 6px -3px rgb(0 0 0 / 0.06), 0px 12px 12px -6px rgb(0 0 0 / 0.06),
  ...
  .shadow-input {
    box-shadow: 0px 2px 3px -1px rgba(0, 0, 0, 0.1),
      ...
      0px 0px 0px 1px rgba(25, 28, 33, 0.08);
                  ...
                  >
                    {copiedCode === "shadows" ? "Copied!" : <Copy className="h-4 w-4" />}
                  </Button>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardContent className="p-6">
                ...
                <div className="relative">
                  <pre className="bg-slate-900 p-4 rounded-lg text-gray-300 text-sm overflow-x-auto">
                    <code>{contactSectionsPack.importExample}</code>
                  </pre>
                  <Button 
                    variant="outline" 
                    size="sm"
                    className="absolute top-3 right-3 border-slate-600"
                    onClick={() => copyToClipboard(contactSectionsPack.importExample, "import")}
                  >
