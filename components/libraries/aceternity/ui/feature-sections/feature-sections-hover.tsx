...
import type { SimpleFeatureSectionsProps } from "./feature-sections.types";
...
export function FeatureSectionsHover({ 
  ...
  return (
    <div className={cn("py-20 lg:py-40", className)}>
      {(title || subtitle) && (
        <div className="px-8 mb-12 text-center max-w-7xl mx-auto">
          {title && (
      ...
      <div className={cn("grid relative z-10 max-w-7xl mx-auto", gridCols[columns])}>
