...
import { Lens } from "./lens-base";
import { motion } from "motion/react";
import { cn } from "../../lib/utils";
import { LensDemoProps, LensGalleryPreviewProps, LensStaticProps } from "./lens.types";

// Basic with Animation - EXACT provided code
export function LensDemo({ className, containerClassName }: LensDemoProps = {}) {
...
// Gallery Preview - Optimized for gallery display
export function LensGalleryPreview({ className, containerClassName }: LensGalleryPreviewProps = {}) {
  const [hovering, setHovering] = useState(false);
...
// Static Lens - EXACT provided code
export function LensStatic({ className, containerClassName, position, zoomFactor, lensSize }: LensStaticProps = {}) {
  return (
    <div className={containerClassName}>
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
        <Rays />
...
// Lens on React Component - EXACT provided code
export function LensOnComponent({ className, containerClassName }: LensDemoProps = {}) {
  const [hovering, setHovering] = useState(false);
...
// EXACT provided SVG components - Sorry about this but it looks cool
