...
import { SignupFormProps, LabelInputContainerProps } from "./signup-form.types";

export function SignupFormDemo({ className, onSubmit }: SignupFormProps = {}) {
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (onSubmit) {
      ...
      onSubmit({
        ...
        twitterpassword: formData.get("twitterpassword") as string,
      });
    } else {
