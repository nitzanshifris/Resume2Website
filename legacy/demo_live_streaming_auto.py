#!/usr/bin/env python3
"""
Live Demo of CV2WEB Enhanced Streaming System (Auto-run version)
    ...
    async with aiohttp.ClientSession() as session:
        ...
        async with session.get(
            ...
            if response.status == 200:
                ...
                if 'aggregation_report' in metrics and metrics['aggregation_report']:
...
async def main():
    ...
    print(f"\n{YELLOW}Starting demo in 2 seconds...{RESET}")
