...
class ComponentAdapter:
    ...
    def _load_component_registry(self) -> Dict[str, Any]:
        ...
        try:
            registry_path = Path(__file__).parent.parent.parent.parent / "aceternity-components-library" / "components" / "registry.json"
            if registry_path.exists():
                with open(registry_path, 'r') as f:
                    return json.load(f)
            
            # Fallback to reading TypeScript registry
            ts_registry_path = Path(__file__).parent.parent.parent.parent / "aceternity-components-library" / "lib" / "component-adapter" / "component-registry.ts"
