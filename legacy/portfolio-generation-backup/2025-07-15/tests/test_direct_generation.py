#!/usr/bin/env python3
"""
Direct portfolio generation test
"""
import asyncio
import logging
...
async def main():
    ...
    logger.info("Selecting components...")
    selections = component_selector.select_components(cv_data)
    
    # Step 4: Generate portfolio
    output_dir = Path("generated-portfolio")
    logger.info(f"Generating portfolio to {output_dir}...")
    ...
    logger.info("🚀 To run: cd generated-portfolio && npm install && npm run dev")
