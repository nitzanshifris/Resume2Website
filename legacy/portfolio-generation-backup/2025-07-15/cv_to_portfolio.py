"""
CV to Portfolio Pipeline - DEPRECATED.

This route is deprecated and will be removed in the next version.
Please use /cv/upload for CV processing and MCP scripts for portfolio generation.
"""
import asyncio
import logging
import tempfile
